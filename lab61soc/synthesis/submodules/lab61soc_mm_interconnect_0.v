...
module lab61soc_mm_interconnect_0 (
		...
		output wire [1:0]  push_btn_s1_address,                            //                              push_btn_s1.address
		input  wire [31:0] push_btn_s1_readdata,                           //                                         .readdata
	...
	wire   [31:0] push_btn_s1_agent_m0_readdata;                                                      // push_btn_s1_translator:uav_readdata -> push_btn_s1_agent:m0_readdata
	wire          push_btn_s1_agent_m0_waitrequest;                                                   // push_btn_s1_translator:uav_waitrequest -> push_btn_s1_agent:m0_waitrequest
	wire          push_btn_s1_agent_m0_debugaccess;                                                   // push_btn_s1_agent:m0_debugaccess -> push_btn_s1_translator:uav_debugaccess
	wire   [27:0] push_btn_s1_agent_m0_address;                                                       // push_btn_s1_agent:m0_address -> push_btn_s1_translator:uav_address
	wire    [3:0] push_btn_s1_agent_m0_byteenable;                                                    // push_btn_s1_agent:m0_byteenable -> push_btn_s1_translator:uav_byteenable
	wire          push_btn_s1_agent_m0_read;                                                          // push_btn_s1_agent:m0_read -> push_btn_s1_translator:uav_read
	wire          push_btn_s1_agent_m0_readdatavalid;                                                 // push_btn_s1_translator:uav_readdatavalid -> push_btn_s1_agent:m0_readdatavalid
	wire          push_btn_s1_agent_m0_lock;                                                          // push_btn_s1_agent:m0_lock -> push_btn_s1_translator:uav_lock
	wire   [31:0] push_btn_s1_agent_m0_writedata;                                                     // push_btn_s1_agent:m0_writedata -> push_btn_s1_translator:uav_writedata
	wire          push_btn_s1_agent_m0_write;                                                         // push_btn_s1_agent:m0_write -> push_btn_s1_translator:uav_write
	wire    [2:0] push_btn_s1_agent_m0_burstcount;                                                    // push_btn_s1_agent:m0_burstcount -> push_btn_s1_translator:uav_burstcount
	wire          push_btn_s1_agent_rf_source_valid;                                                  // push_btn_s1_agent:rf_source_valid -> push_btn_s1_agent_rsp_fifo:in_valid
	wire  [104:0] push_btn_s1_agent_rf_source_data;                                                   // push_btn_s1_agent:rf_source_data -> push_btn_s1_agent_rsp_fifo:in_data
	wire          push_btn_s1_agent_rf_source_ready;                                                  // push_btn_s1_agent_rsp_fifo:in_ready -> push_btn_s1_agent:rf_source_ready
	wire          push_btn_s1_agent_rf_source_startofpacket;                                          // push_btn_s1_agent:rf_source_startofpacket -> push_btn_s1_agent_rsp_fifo:in_startofpacket
	wire          push_btn_s1_agent_rf_source_endofpacket;                                            // push_btn_s1_agent:rf_source_endofpacket -> push_btn_s1_agent_rsp_fifo:in_endofpacket
	wire          push_btn_s1_agent_rsp_fifo_out_valid;                                               // push_btn_s1_agent_rsp_fifo:out_valid -> push_btn_s1_agent:rf_sink_valid
	wire  [104:0] push_btn_s1_agent_rsp_fifo_out_data;                                                // push_btn_s1_agent_rsp_fifo:out_data -> push_btn_s1_agent:rf_sink_data
	wire          push_btn_s1_agent_rsp_fifo_out_ready;                                               // push_btn_s1_agent:rf_sink_ready -> push_btn_s1_agent_rsp_fifo:out_ready
	wire          push_btn_s1_agent_rsp_fifo_out_startofpacket;                                       // push_btn_s1_agent_rsp_fifo:out_startofpacket -> push_btn_s1_agent:rf_sink_startofpacket
	wire          push_btn_s1_agent_rsp_fifo_out_endofpacket;                                         // push_btn_s1_agent_rsp_fifo:out_endofpacket -> push_btn_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> push_btn_s1_agent:cp_valid
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> push_btn_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // push_btn_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> push_btn_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> push_btn_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> push_btn_s1_agent:cp_endofpacket
	...
	wire          push_btn_s1_agent_rp_valid;                                                         // push_btn_s1_agent:rp_valid -> router_009:sink_valid
	wire  [103:0] push_btn_s1_agent_rp_data;                                                          // push_btn_s1_agent:rp_data -> router_009:sink_data
	wire          push_btn_s1_agent_rp_ready;                                                         // router_009:sink_ready -> push_btn_s1_agent:rp_ready
	wire          push_btn_s1_agent_rp_startofpacket;                                                 // push_btn_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          push_btn_s1_agent_rp_endofpacket;                                                   // push_btn_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          push_btn_s1_agent_rdata_fifo_src_valid;                                             // push_btn_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] push_btn_s1_agent_rdata_fifo_src_data;                                              // push_btn_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          push_btn_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_007:in_0_ready -> push_btn_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> push_btn_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> push_btn_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // push_btn_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> push_btn_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) push_btn_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (push_btn_s1_agent_m0_address),                   // avalon_universal_slave_0.address
		.uav_burstcount         (push_btn_s1_agent_m0_burstcount),                //                         .burstcount
		.uav_read               (push_btn_s1_agent_m0_read),                      //                         .read
		.uav_write              (push_btn_s1_agent_m0_write),                     //                         .write
		.uav_waitrequest        (push_btn_s1_agent_m0_waitrequest),               //                         .waitrequest
		.uav_readdatavalid      (push_btn_s1_agent_m0_readdatavalid),             //                         .readdatavalid
		.uav_byteenable         (push_btn_s1_agent_m0_byteenable),                //                         .byteenable
		.uav_readdata           (push_btn_s1_agent_m0_readdata),                  //                         .readdata
		.uav_writedata          (push_btn_s1_agent_m0_writedata),                 //                         .writedata
		.uav_lock               (push_btn_s1_agent_m0_lock),                      //                         .lock
		.uav_debugaccess        (push_btn_s1_agent_m0_debugaccess),               //                         .debugaccess
		.av_address             (push_btn_s1_address),                            //      avalon_anti_slave_0.address
		.av_readdata            (push_btn_s1_readdata),                           //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
		.av_writedata           (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (push_btn_s1_agent_m0_address),                   //              m0.address
		.m0_burstcount           (push_btn_s1_agent_m0_burstcount),                //                .burstcount
		.m0_byteenable           (push_btn_s1_agent_m0_byteenable),                //                .byteenable
		.m0_debugaccess          (push_btn_s1_agent_m0_debugaccess),               //                .debugaccess
		.m0_lock                 (push_btn_s1_agent_m0_lock),                      //                .lock
		.m0_readdata             (push_btn_s1_agent_m0_readdata),                  //                .readdata
		.m0_readdatavalid        (push_btn_s1_agent_m0_readdatavalid),             //                .readdatavalid
		.m0_read                 (push_btn_s1_agent_m0_read),                      //                .read
		.m0_waitrequest          (push_btn_s1_agent_m0_waitrequest),               //                .waitrequest
		.m0_writedata            (push_btn_s1_agent_m0_writedata),                 //                .writedata
		.m0_write                (push_btn_s1_agent_m0_write),                     //                .write
		.rp_endofpacket          (push_btn_s1_agent_rp_endofpacket),               //              rp.endofpacket
		.rp_ready                (push_btn_s1_agent_rp_ready),                     //                .ready
		.rp_valid                (push_btn_s1_agent_rp_valid),                     //                .valid
		.rp_data                 (push_btn_s1_agent_rp_data),                      //                .data
		.rp_startofpacket        (push_btn_s1_agent_rp_startofpacket),             //                .startofpacket
		...
		.rf_sink_ready           (push_btn_s1_agent_rsp_fifo_out_ready),           //         rf_sink.ready
		.rf_sink_valid           (push_btn_s1_agent_rsp_fifo_out_valid),           //                .valid
		.rf_sink_startofpacket   (push_btn_s1_agent_rsp_fifo_out_startofpacket),   //                .startofpacket
		.rf_sink_endofpacket     (push_btn_s1_agent_rsp_fifo_out_endofpacket),     //                .endofpacket
		.rf_sink_data            (push_btn_s1_agent_rsp_fifo_out_data),            //                .data
		.rf_source_ready         (push_btn_s1_agent_rf_source_ready),              //       rf_source.ready
		.rf_source_valid         (push_btn_s1_agent_rf_source_valid),              //                .valid
		.rf_source_startofpacket (push_btn_s1_agent_rf_source_startofpacket),      //                .startofpacket
		.rf_source_endofpacket   (push_btn_s1_agent_rf_source_endofpacket),        //                .endofpacket
		.rf_source_data          (push_btn_s1_agent_rf_source_data),               //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),              //                .error
		.rdata_fifo_src_ready    (push_btn_s1_agent_rdata_fifo_src_ready),         //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (push_btn_s1_agent_rdata_fifo_src_valid),         //                .valid
		.rdata_fifo_src_data     (push_btn_s1_agent_rdata_fifo_src_data),          //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) push_btn_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (push_btn_s1_agent_rf_source_data),               //        in.data
		.in_valid          (push_btn_s1_agent_rf_source_valid),              //          .valid
		.in_ready          (push_btn_s1_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (push_btn_s1_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (push_btn_s1_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (push_btn_s1_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (push_btn_s1_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (push_btn_s1_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (push_btn_s1_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (push_btn_s1_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	lab61soc_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (push_btn_s1_agent_rp_ready),                     //      sink.ready
		.sink_valid         (push_btn_s1_agent_rp_valid),                     //          .valid
		.sink_data          (push_btn_s1_agent_rp_data),                      //          .data
		.sink_startofpacket (push_btn_s1_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (push_btn_s1_agent_rp_endofpacket),               //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (push_btn_s1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (push_btn_s1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (push_btn_s1_agent_rdata_fifo_src_ready),         //         .ready
